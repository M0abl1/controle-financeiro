...
export function AuthGate({
  ...
  useEffect(() => {
    ...
    const loadingTimeout = window.setTimeout(() => {
      ...
      setError("A sessÃ£o demorou para responder. Tente entrar novamente.");
      setStatus("signedOut");
    }, 8000);
      ...
      <section className="login-brand">
        ...
        <div className="security-note">
          ...
          <div>
            ...
            <small>
              Somente a conta proprietária autorizada no Firebase pode acessar
              os dados.
            </small>
          </div>
        </div>
      ...
      <section className="login-card">
        ...
        {status === "configError" ? (
          <>
            ...
            <p>
              Preencha as variáveis VITE_FIREBASE_* no arquivo{" "}
              <code>.env.local</code>.
            </p>
          </>
        ) : status === "denied" ? (
          ...
          <>
            ...
            <p>Entre com a conta Google autorizada como dona deste sistema.</p>
        ...
        <small className="login-foot">
          <LockKeyhole /> Autenticação protegida pelo Google Firebase
        </small>
      </section>
    </main>
  );
